        ...
        <li className="Footer_icon">
          ...
          >
            <g filter="url(#filter0_di_1_247)">
              ...
              />
              <path
                d="M56.188 23C55.671 23 55.447 23.325 55.261 23.66C55.261 23.66 47.806 36.884 47.559 37.317C47.574 37.341 52.478 46.34 52.478 46.34C52.648 46.648 52.914 47 53.445 47H56.899C57.11 47 57.274 46.922 57.362 46.78C57.451 46.629 57.451 46.434 57.353 46.244L52.474 37.328C52.4719 37.3247 52.4707 37.3209 52.4707 37.317C52.4707 37.3131 52.4719 37.3093 52.474 37.306L60.139 23.756C60.234 23.565 60.236 23.369 60.145 23.221C60.056 23.078 59.894 23 59.686 23H56.188ZM41.648 27.74C41.437 27.74 41.263 27.814 41.175 27.956C41.085 28.105 41.097 28.295 41.195 28.487L43.535 32.537C43.539 32.5463 43.539 32.5533 43.535 32.558L39.86 39.051C39.8127 39.1311 39.7877 39.2225 39.7877 39.3155C39.7877 39.4085 39.8127 39.4999 39.86 39.58C39.945 39.722 40.099 39.814 40.31 39.814H43.771C44.289 39.814 44.537 39.466 44.716 39.147L48.45 32.538L46.072 28.383C45.9 28.068 45.638 27.724 45.11 27.724H41.648V27.74Z"
                fill="#8C8C8C"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="shape"
                  result="effect2_innerShadow_1_247"
                />
              </filter>
              <linearGradient
        ...
        <li className="Footer_icon">
          ...
          >
            <g filter="url(#filter0_di_1_250)">
              ...
              />
              <path
                d="M60.46 29.3529C59.69 29.7647 58.86 30.0353 58 30.1647C58.88 29.5412 59.56 28.5529 59.88 27.3647C59.05 27.9529 58.13 28.3647 57.16 28.6C56.37 27.5882 55.26 27 54 27C51.65 27 49.73 29.2588 49.73 32.0471C49.73 32.4471 49.77 32.8353 49.84 33.2C46.28 32.9882 43.11 30.9765 41 27.9294C40.63 28.6706 40.42 29.5412 40.42 30.4588C40.42 32.2118 41.17 33.7647 42.33 34.6471C41.62 34.6471 40.96 34.4118 40.38 34.0588V34.0941C40.38 36.5412 41.86 38.5882 43.82 39.0471C43.1908 39.2505 42.53 39.2787 41.89 39.1294C42.1616 40.1323 42.6935 41.0099 43.411 41.6387C44.1285 42.2676 44.9955 42.6161 45.89 42.6353C44.3737 44.0477 42.494 44.8111 40.56 44.8C40.22 44.8 39.88 44.7765 39.54 44.7294C41.44 46.1647 43.7 47 46.12 47C54 47 58.33 39.3059 58.33 32.6353C58.33 32.4118 58.33 32.2 58.32 31.9765C59.16 31.2706 59.88 30.3765 60.46 29.3529Z"
                fill="#8C8C8C"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="shape"
                  result="effect2_innerShadow_1_250"
                />
              </filter>
              <linearGradient
